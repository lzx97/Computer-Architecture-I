...
add wave -noupdate /cpu_testbench/bltandout
add wave -noupdate /cpu_testbench/xorout
add wave -noupdate /cpu_testbench/ucborout
add wave -noupdate /cpu_testbench/UBranch
add wave -noupdate /cpu_testbench/Branch
add wave -noupdate /cpu_testbench/muxbrsel
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {56915179 ps} 0}
